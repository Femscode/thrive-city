...
@section('content')
    <div class="bg-white shadow rounded mb-4">
        <div class="p-4 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
                <h3 class="text-base font-semibold text-slate-900">Marketplace</h3>
                <p class="text-sm text-slate-500 mt-1">
                    Share this link with customers or preview the marketplace page.
                </p>
            </div>
            <div class="flex flex-col gap-2 md:w-96">
                <div class="flex items-center gap-2">
                    <input
                        id="products-marketplace-url-input"
                        type="text"
                        readonly
                    ...
                    <button
                        type="button"
                        id="products-marketplace-copy-btn"
...
@push('scripts')
    ...
    <script>
        $(function() {
            ...
            const input = document.getElementById('products-marketplace-url-input');
            const btn = document.getElementById('products-marketplace-copy-btn');
            if (input && btn) {
